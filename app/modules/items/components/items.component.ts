...
export class ItemsComponent implements OnInit {
    ...
    public ngOnInit() {
        ...
        timer.setInterval(() => {
            ...
            else{this.groupView = <RadListView>this.page.getViewById("groupView");}
            
        }, 1000);

        this.myGroupingFunc = (item: Item) => {
                if(this.groupId == 1){return item.franchise}
                else if (this.groupId == 2){return item.series}
                else if (this.groupId == 3){return item.toyLine}
